...
public class CreateAccountantPageObject extends BasePage {
	...
	public CreateAccountantPageObject(WebDriver driver) {
		this.driver = driver;
	}

	public CreateUserManagementPageObject clickCancelAccountantButton() {
		waitForElementClickable(driver, AdminHomePageUI.CANCEL_ACCOUNTANT_BUTTON);
		clickToElement(driver, AdminHomePageUI.CANCEL_ACCOUNTANT_BUTTON);
	...
	public CreateAccountAccountantPageObject clickNextAccountantButton() {
		...
		return new CreateAccountAccountantPageObject(driver);
	}
	...
	public void clickToValueNationality() {
		scrollToElement(driver, AdminHomePageUI.VALUE_NATIONALITY_ACCOUNTANT_INPUT);
		sleepInSecond(SHORT_TIMEOUT);
		waitForElementClickable(driver, AdminHomePageUI.VALUE_NATIONALITY_ACCOUNTANT_INPUT);
		clickToElement(driver, AdminHomePageUI.VALUE_NATIONALITY_ACCOUNTANT_INPUT);
	}
	...
	public void clickToValueNation() {
		scrollToElement(driver, AdminHomePageUI.VALUE_NATION_ACCOUNTANT_INPUT);
		sleepInSecond(SHORT_TIMEOUT);
		waitForElementClickable(driver, AdminHomePageUI.VALUE_NATION_ACCOUNTANT_INPUT);
		clickToElement(driver, AdminHomePageUI.VALUE_NATION_ACCOUNTANT_INPUT);
	}
}
