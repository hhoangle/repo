...
public class CreateWarehousePageObject extends BasePage {
	...
	public CreateWarehousePageObject(WebDriver driver) {
		this.driver = driver;
	}

	public CreateUserManagementPageObject clickCancelWarehouseButton() {
		waitForElementClickable(driver, AdminHomePageUI.CANCEL_WAREHOUSE_BUTTON);
		clickToElement(driver, AdminHomePageUI.CANCEL_WAREHOUSE_BUTTON);
	...
	public CreateAccountWarehousePageObject clickNextWarehouseButton() {
		...
		return new CreateAccountWarehousePageObject(driver);
	}
